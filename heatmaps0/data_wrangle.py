...
for idx in range(0, len(description)):
    ...
    os.makedirs(os.path.dirname("images_torch2/"+"{:03d}".format(int(idx/1000))+"/image_torch"+"{:06d}".format(idx)), exist_ok=True)
    os.makedirs(
    ...
    os.makedirs(
        ...
        exist_ok=True)
    torch.save(image, "images_torch2/"+"{:03d}".format(int(idx/1000))+"/image_torch"+"{:06d}".format(idx))
